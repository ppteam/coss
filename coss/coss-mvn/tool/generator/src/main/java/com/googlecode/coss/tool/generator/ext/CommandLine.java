package com.googlecode.coss.tool.generator.ext;

import java.io.File;
import java.util.Scanner;

import com.googlecode.coss.tool.generator.GeneratorFacade;
import com.googlecode.coss.tool.generator.GeneratorProperties;
import com.googlecode.coss.tool.generator.util.ArrayHelper;
...
public class CommandLine {
	...
	private static String getTemplateRootDir() {
		String templateRootDir = System.getProperty("templateRootDir", "template");
	...
	private static void printUsages() {
		...
		System.out.println("\t[include_path] subdir of templateRootDir,example: 1. dao  2. dao/**,dataobject/**");
