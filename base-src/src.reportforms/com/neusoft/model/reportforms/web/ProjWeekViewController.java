 ...
 */
@Controller
@RequestMapping(value = "/projweek")
public class ProjWeekViewController extends AbstractController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(ProjWeekViewController.class);

	public ProjWeekViewController() {
	}
