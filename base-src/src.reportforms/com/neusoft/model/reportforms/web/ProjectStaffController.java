 ...
 */
@Controller
@RequestMapping(value = "/projectStaff")
public class ProjectStaffController extends AbstractController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(ProjectStaffController.class);

	public ProjectStaffController() {
	}
	...
	public String console(HttpServletRequest request, ModelMap modelMap) {
		...
		return "model/projectStaffReport";
	}
}
