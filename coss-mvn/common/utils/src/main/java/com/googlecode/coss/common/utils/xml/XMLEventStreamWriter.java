...
class XMLEventStreamWriter implements XMLStreamWriter {
    ...
    public void writeStartElement(String namespaceURI, String localName) throws XMLStreamException {
        writeStartElement(eventFactory.createStartElement(new QName(namespaceURI, localName), null,
                null));
    }

    public void writeStartElement(String prefix, String localName, String namespaceURI)
            throws XMLStreamException {
        writeStartElement(eventFactory.createStartElement(
    ...
    private void writeNamespace(Namespace namespace) throws XMLStreamException {
        ...
        EndElement newEndElement = eventFactory.createEndElement(oldEndElement.getName(),
