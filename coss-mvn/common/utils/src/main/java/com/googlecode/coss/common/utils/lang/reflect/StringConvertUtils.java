...
import com.googlecode.coss.common.utils.lang.DateTime.DateUtils;
...
public class StringConvertUtils {
    ...
    public static <T> T convertStringToObject(String str, Class<T> c) {
        ...
        if (String.class.equals(c)) {
            ...
            throw new IllegalArgumentException(String.format("String %s can not convert to %s",
                    str, c.getName()));
        }
        return (T) o;
    }
