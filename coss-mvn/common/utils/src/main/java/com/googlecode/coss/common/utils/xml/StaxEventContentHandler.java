...
class StaxEventContentHandler extends AbstractStaxContentHandler {
    ...
    /**
     * Constructs a new instance of the <code>StaxEventContentHandler</code>
     * that writes to the given <code>XMLEventConsumer</code>. A default
    ...
    /**
     * Constructs a new instance of the <code>StaxEventContentHandler</code>
     * that uses the given event factory to create events and writes to the
     * given <code>XMLEventConsumer</code>.
     * 
     * @param consumer the consumer to write events to
    ...
    @Override
    protected void endElementInternal(QName name, SimpleNamespaceContext namespaceContext)
            throws XMLStreamException {
        List namespaces = createNamespaces(namespaceContext);
        consumeEvent(eventFactory.createEndElement(name, namespaces != null ? namespaces.iterator()
                : null));
    }
    ...
    /**
     * Creates and returns a list of <code>NameSpace</code> objects from the
