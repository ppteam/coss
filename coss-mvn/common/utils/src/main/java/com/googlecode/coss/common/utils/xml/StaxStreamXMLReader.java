...
class StaxStreamXMLReader extends AbstractStaxXMLReader {
    ...
    protected void parseInternal() throws SAXException, XMLStreamException {
        ...
        while (true) {
            if (eventType != XMLStreamConstants.START_DOCUMENT
                    && eventType != XMLStreamConstants.END_DOCUMENT && !documentStarted) {
                handleStartDocument();
    ...
    private void handleCharacters() throws SAXException {
        ...
        if (getContentHandler() != null) {
            getContentHandler().characters(reader.getTextCharacters(), reader.getTextStart(),
    ...
    private void handleComment() throws SAXException {
        if (getLexicalHandler() != null) {
            getLexicalHandler().comment(reader.getTextCharacters(), reader.getTextStart(),
                    reader.getTextLength());
        }
    }
