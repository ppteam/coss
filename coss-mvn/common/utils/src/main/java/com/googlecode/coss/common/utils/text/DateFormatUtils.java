...
public class DateFormatUtils {
     ...
     * @param targetType long or String
     * @param formats format String or String[]
     * @return
     */
    ...
    public static Date parse(String dateString, String dateFormat, Class targetResultType) {
        ...
        try {
            ...
            String errorInfo = (new StringBuilder()).append("cannot use dateformat:")
                    .append(dateFormat).append(" parse datestring:").append(dateString).toString();
            throw new IllegalArgumentException(errorInfo, e);
        } catch (Exception e) {
            throw new IllegalArgumentException((new StringBuilder())
                    .append("error targetResultType:").append(targetResultType.getName())
                    .toString(), e);
        }
    }
