...
public class ReflectUtils {
     ...
     * @throws IllegalAccessException
     */
    public static Object inject(Class<?> c, Map<String, Object> fieldNameAndValues)
            throws InstantiationException, ClassNotFoundException, IllegalAccessException {
     ...
     * @throws IllegalAccessException
     */
    public static Object inject(Object target, Map<String, Object> fieldNameAndValues)
            throws InstantiationException, ClassNotFoundException, IllegalAccessException {
        ...
        for (Map.Entry<String, Object> keyValue : keyValues) {
            ...
            Expression exp = new Expression(target, methodName,
        ...
        for (int i = 0; i < descriptors.length; i++) {
            ...
            if (readMethod != null) {
                try {
                    ...
                    throw new RuntimeException("error get property value,name:" + name
                            + " on bean:" + obj, e);
                }
            }
        }
    ...
    private static Object convert(String value, Class<?> targetType) {
        ...
        if (DateFormatUtils.isDateType(targetType)) {
            return DateFormatUtils.parse(value, targetType, "yyyyMMdd", "yyyy-MM-dd",
