...
/**
 * 与具体ORM实现无关的属性过滤条件封装类. PropertyFilter主要记录页面中简单的搜索过滤条件,比Hibernate的Criterion要简单.
 */
public class PropertyFilter {
    ...
    public PropertyFilter(final String filterName, final String value) {
        ...
        this.propertyValue = ReflectionHelper.convertStringToObject(value, propertyType);
    }
