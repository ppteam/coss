package com.googlecode.coss.common.core.orm.mybatis.plugin;
...
import com.googlecode.coss.common.core.helper.PropertiesHelper;
import com.googlecode.coss.common.core.orm.mybatis.dialect.Dialect;

/**
 * 为Mybatis提供基于方言(Dialect)的分页查询的插件 将拦截Executor.query()方法实现分页方言的插入. 配置文件内容:
 * 
 * <pre>
 * 	&lt;plugins>
