package com.googlecode.coss.tool.generator.provider.db.table.model;

import java.util.List;

import com.googlecode.coss.tool.generator.GeneratorProperties;
import com.googlecode.coss.tool.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.googlecode.coss.tool.generator.provider.db.table.model.util.ColumnHelper;
import com.googlecode.coss.tool.generator.util.GLogger;
import com.googlecode.coss.tool.generator.util.StringHelper;
import com.googlecode.coss.tool.generator.util.TestDataGenerator;
import com.googlecode.coss.tool.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.googlecode.coss.tool.generator.util.typemapping.DatabaseDataTypesUtils;
import com.googlecode.coss.tool.generator.util.typemapping.JavaPrimitiveTypeMapping;
...
public class Column {
    ...
    public Column(Column c) {
        this(c.getTable(), c.getSqlType(), c.getSqlTypeName(), c.getColumnName(), c.getSize(), c
