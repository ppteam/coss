...
package com.googlecode.coss.tool.generator.util;
...
/**
 * copy from springframework Utility class for working with Strings that have
 * placeholder values in them. A placeholder takes the form <code>${name}</code>
 * . Using <code>PropertyPlaceholderHelper</code> these placeholders can be
...
public class PropertyPlaceholderHelper {
     ...
     *            placeholders should be ignored (<code>true</code>) or cause an
     ...
     * 
     * @param value the value containing the placeholders to be replaced.
     * @param placeholderResolver the <code>PlaceholderResolver</code> to use
     *            for replacement.
     * @return the supplied value with placeholders replaced inline.
     */
