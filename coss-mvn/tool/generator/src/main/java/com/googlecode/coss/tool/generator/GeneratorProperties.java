...
import com.googlecode.coss.tool.generator.util.PropertiesHelper;
import com.googlecode.coss.tool.generator.util.PropertyPlaceholderHelper;
import com.googlecode.coss.tool.generator.util.PropertyPlaceholderHelper.PropertyPlaceholderConfigurerResolver;
...
public class GeneratorProperties {
    ...
    static final String              PROPERTIES_FILE_NAMES[] = new String[] {
            "generator.properties", "generator.xml", "custom-generator.properties",
            "custom-generator.xml"                          };

    static PropertiesHelper          props                   = new PropertiesHelper(
                                                                     new Properties(), true);
