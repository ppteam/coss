package com.googlecode.coss.tool.generator.provider.db.sql.model;

import java.util.Iterator;
import java.util.LinkedHashSet;

import com.googlecode.coss.tool.generator.provider.db.sql.SqlFactory;
...
public class Sql {
    ...
    public String getResultClass() {
        ...
        if (isColumnsInSameTable()) {
            ...
            return StringHelper.makeAllWordFirstLetterUpperCase(StringHelper
                    .toUnderscoreName(operation)) + "Result";
        }
    }
    ...
    public String getParameterClassName() {
        ...
        return lastIndexOf >= 0 ? getParameterClass().substring(lastIndexOf + 1)
                : getParameterClass();
    }
