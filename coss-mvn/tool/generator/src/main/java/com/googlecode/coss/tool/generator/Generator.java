...
import com.googlecode.coss.tool.generator.util.AntPathMatcher;
import com.googlecode.coss.tool.generator.util.BeanHelper;
import com.googlecode.coss.tool.generator.util.FileHelper;
import com.googlecode.coss.tool.generator.util.FreemarkerHelper;
...
public class Generator {
    ...
    private String              removeExtensions                = System.getProperty(
                                                                        "generator.removeExtensions",
                                                                        ".ftl,.vm");
    ...
    private String              sourceEncoding                  = System.getProperty(
                                                                        "generator.sourceEncoding",
                                                                        "UTF-8");
    private String              outputEncoding                  = System.getProperty(
                                                                        "generator.outputEncoding",
                                                                        "UTF-8");
