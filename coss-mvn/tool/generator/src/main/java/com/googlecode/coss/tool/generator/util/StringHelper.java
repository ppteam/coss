...
import com.googlecode.coss.tool.generator.provider.db.table.model.Column.EnumMetaDada;
...
public class StringHelper {
	...
	public static String makeAllWordFirstLetterUpperCase(String sqlName) {
		return makeAllWordFirstLetterUpperCase(sqlName, "_");
	}

	//doit 可以配置分隔符
	public static String makeAllWordFirstLetterUpperCase(String sqlName, String separator) {
		String[] strs = sqlName.toLowerCase().split(separator);
		String result = "";
		String preStr = "";
