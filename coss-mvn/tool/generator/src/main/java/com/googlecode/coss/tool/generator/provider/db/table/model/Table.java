...
public class Table {
    ...
    /**
     * 根据sqlName得到的类名称，使用分隔符匹配规则，示例值: user_info ==> UserInfo
     * 
     * @return
     */
    public String getClassName() {
        if (StringHelper.isBlank(className)) {
            ...
            String separator = GeneratorProperties.getProperty("caseSeparatorPattern", "_");
            className = StringHelper.makeAllWordFirstLetterUpperCase(
                    StringHelper.toUnderscoreName(removedPrefixSqlName), separator);
        }
        return className;
    }
